...
<body id="<?php echo $PageId ?>">
        <div class="container">
        <header>
            <div class="leftsection"><h2>Manage Salary</h2></div>
        ...
        <div class="outer-table-container">
            <div class="table-container">
                <table id="table">
                <?php
                require_once("SalaryDb.php");
                if(isset($_GET['search'])){

                    if(empty($_GET['search'])){
                        header("location:../Salary/Salary.php");
                    }
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                        ...
                        foreach($query_run as $row){
                            ...
                            <tr>
                                ...
                                <td class="action">
                                    <a href="StaffSalary.php?Idnumber=<?php echo $row['Idnumber']?>"><img src="../BG/add_card_FILL0_wght400_GRAD0_opsz24.svg"></a>
                                </td>
                            </tr>
                            <?php
                        }
