...
<body id="<?php echo $PageId ?>">
        <div class="container">
        <header>
            <div class="leftsection"><h2>Staff Leave Status</h2></div>
            ...
            <div class="table-container">
                ...
                if(isset($_GET['search'])){
                    ...
                    if(empty($_GET['search'])){
                        header("location:../Leaves/Leave.php");
                    }

                    else{
                        
                    $Filter = $_GET['search'];
                    $query = "SELECT * FROM staff_leaves_status WHERE CONCAT(Leave2_Id, Department ,Staff_Fullname, Staff_Contact, Staff_Date_Requested, Staff_Requested_Date, Staff_Reason, Status) LIKE '%$Filter%'";
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                        ...
                        foreach($query_run as $row){                            
                            ...
                            <tr>
                                ...
                                <td><img src="../Leaves/LeaveIcon/<?php echo $row['Status'] ?>"/></td>
                            </tr>
                            <?php
                        }
                    }
                ...
                $onset = 0;
                $rows_per_page = 10;
                $records = $con->query("SELECT * FROM staff_leaves_status");
                ...
                require_once("LeaveDb.php");
                $query = "SELECT * FROM staff_leaves_status ORDER BY Leave2_Id DESC LIMIT $onset, $rows_per_page ";
