...
<body id="<?php echo $PageId ?>">
        <div class="container">
        <header>
            <div class="leftsection"><h2>Manage Department</h2></div>
                    ...
                    if(mysqli_num_rows($query_run) > 0){
                        ...
                        foreach($query_run as $row){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="EditStaff.php?Department_Id=<?php echo $row['Department_Id']?>"><img src="../BG/person_edit_FILL0_wght400_GRAD0_opsz24.svg"></a>
                                    <a href="DeleteStaff.php?Department_Id=<?php echo $row['Department_Id']?>" onclick='return checkdelete()' ><img src="../BG/delete_forever_FILL0_wght400_GRAD0_opsz24.svg"></a>
                                </td>
                            </tr>
                            <?php
                        }
                ...
                ?>
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['Department_Name']?></td>
                            <td class="action">
                                <a class="action" href="EditDepartment.php?Department_Id=<?php echo $row['Department_Id']?>"><img src="../BG/person_edit_FILL0_wght400_GRAD0_opsz24.svg"></a>
                                <a class="action" href="DeleteDepartment.php?Department_Id=<?php echo $row['Department_Id']?>" onclick='return checkdelete()' ><img src="../BG/delete_forever_FILL0_wght400_GRAD0_opsz24.svg"></a>
                            </td>
                        </tr>
                            <?php
                        }
   ...
   <p> &#169; jhonric eugenio gorillo</p>
    ...
    <script>
        function checkdelete(){
                return confirm('Delete Department?');
            }
    </script>
